    ...
    const ROMPLER_GM_BANKS = [
      { name: 'Piano',       items: ['acoustic_grand_piano','bright_acoustic_piano','electric_grand_piano','honkytonk_piano','electric_piano_1','electric_piano_2','harpsichord','clavinet'] },
      { name: 'Chrom. Perc', items: ['celesta','glockenspiel','music_box','vibraphone','marimba','xylophone','tubular_bells','dulcimer'] },
      { name: 'Organ',       items: ['drawbar_organ','percussive_organ','rock_organ','church_organ','reed_organ','accordion','harmonica','tango_accordion'] },
      { name: 'Guitar',      items: ['acoustic_guitar_nylon','acoustic_guitar_steel','electric_guitar_jazz','electric_guitar_clean','electric_guitar_muted','overdriven_guitar','distortion_guitar','guitar_harmonics'] },
      { name: 'Bass',        items: ['acoustic_bass','electric_bass_finger','electric_bass_pick','fretless_bass','slap_bass_1','slap_bass_2','synth_bass_1','synth_bass_2'] },
      { name: 'Strings',     items: ['violin','viola','cello','contrabass','tremolo_strings','pizzicato_strings','orchestral_harp','timpani'] },
      { name: 'Ensemble',    items: ['string_ensemble_1','string_ensemble_2','synth_strings_1','synth_strings_2','choir_aahs','voice_oohs','synth_choir','orchestra_hit'] },
      { name: 'Brass',       items: ['trumpet','trombone','tuba','muted_trumpet','french_horn','brass_section','synth_brass_1','synth_brass_2'] },
      { name: 'Reed',        items: ['soprano_sax','alto_sax','tenor_sax','baritone_sax','oboe','english_horn','bassoon','clarinet'] },
      { name: 'Pipe',        items: ['piccolo','flute','recorder','pan_flute','blown_bottle','shakuhachi','whistle','ocarina'] },
      { name: 'Synth Lead',  items: ['lead_1_square','lead_2_sawtooth','lead_3_calliope','lead_4_chiff','lead_5_charang','lead_6_voice','lead_7_fifths','lead_8_bass__lead'] },
      { name: 'Synth Pad',   items: ['pad_1_new_age','pad_2_warm','pad_3_polysynth','pad_4_choir','pad_5_bowed','pad_6_metallic','pad_7_halo','pad_8_sweep'] },
      ...
      { name: 'Ethnic',      items: ['sitar','banjo','shamisen','koto','kalimba','bagpipe','fiddle','shanai'] },
      { name: 'Percussive',  items: ['tinkle_bell','agogo','steel_drums','woodblock','taiko_drum','melodic_tom','synth_drum','reverse_cymbal'] },
      { name: 'Sound FX',    items: ['guitar_fret_noise','breath_noise','seashore','bird_tweet','telephone_ring','helicopter','applause','gunshot'] },
    ];
